// @routes-hash 1d8352259c4b1c7d0fa4accd1acfedf0
...
import route117 from "./routes/setting/dev/getSwitchAiDevTool";
import route118 from "./routes/setting/dev/updateSwitchAiDevTool";
import route119 from "./routes/setting/fileManagement/openFolder";
import route120 from "./routes/setting/getTextModel";
import route121 from "./routes/setting/loginConfig/getUser";
import route122 from "./routes/setting/loginConfig/updateUserPwd";
import route123 from "./routes/setting/memoryConfig/delAllMemory";
import route124 from "./routes/setting/memoryConfig/getMemory";
import route125 from "./routes/setting/memoryConfig/sureMemory";
import route126 from "./routes/setting/modelMap/bindingPrompt";
import route127 from "./routes/setting/modelMap/getImageAndVideoModel";
import route128 from "./routes/setting/promptManage/getPrompt";
import route129 from "./routes/setting/promptManage/updatePrompt";
import route130 from "./routes/setting/skillManagement/getSkillContent";
import route131 from "./routes/setting/skillManagement/getSkillList";
import route132 from "./routes/setting/skillManagement/saveSkillContent";
import route133 from "./routes/setting/vendorConfig/addVendor";
import route134 from "./routes/setting/vendorConfig/addVendorModel";
import route135 from "./routes/setting/vendorConfig/deleteVendor";
import route136 from "./routes/setting/vendorConfig/delVendorModel";
import route137 from "./routes/setting/vendorConfig/enableVendor";
import route138 from "./routes/setting/vendorConfig/getCodeByLink";
import route139 from "./routes/setting/vendorConfig/getVendorList";
import route140 from "./routes/setting/vendorConfig/modelTest";
import route141 from "./routes/setting/vendorConfig/updateCode";
import route142 from "./routes/setting/vendorConfig/updateVendorInputs";
import route143 from "./routes/setting/vendorConfig/upVendorModel";
import route144 from "./routes/task/getProject";
import route145 from "./routes/task/getTaskApi";
import route146 from "./routes/task/getTaskCategories";
import route147 from "./routes/task/taskDetails";
import route148 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/setting/dev/getSwitchAiDevTool", route117);
  app.use("/api/setting/dev/updateSwitchAiDevTool", route118);
  app.use("/api/setting/fileManagement/openFolder", route119);
  app.use("/api/setting/getTextModel", route120);
  app.use("/api/setting/loginConfig/getUser", route121);
  app.use("/api/setting/loginConfig/updateUserPwd", route122);
  app.use("/api/setting/memoryConfig/delAllMemory", route123);
  app.use("/api/setting/memoryConfig/getMemory", route124);
  app.use("/api/setting/memoryConfig/sureMemory", route125);
  app.use("/api/setting/modelMap/bindingPrompt", route126);
  app.use("/api/setting/modelMap/getImageAndVideoModel", route127);
  app.use("/api/setting/promptManage/getPrompt", route128);
  app.use("/api/setting/promptManage/updatePrompt", route129);
  app.use("/api/setting/skillManagement/getSkillContent", route130);
  app.use("/api/setting/skillManagement/getSkillList", route131);
  app.use("/api/setting/skillManagement/saveSkillContent", route132);
  app.use("/api/setting/vendorConfig/addVendor", route133);
  app.use("/api/setting/vendorConfig/addVendorModel", route134);
  app.use("/api/setting/vendorConfig/deleteVendor", route135);
  app.use("/api/setting/vendorConfig/delVendorModel", route136);
  app.use("/api/setting/vendorConfig/enableVendor", route137);
  app.use("/api/setting/vendorConfig/getCodeByLink", route138);
  app.use("/api/setting/vendorConfig/getVendorList", route139);
  app.use("/api/setting/vendorConfig/modelTest", route140);
  app.use("/api/setting/vendorConfig/updateCode", route141);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route142);
  app.use("/api/setting/vendorConfig/upVendorModel", route143);
  app.use("/api/task/getProject", route144);
  app.use("/api/task/getTaskApi", route145);
  app.use("/api/task/getTaskCategories", route146);
  app.use("/api/task/taskDetails", route147);
  app.use("/api/test/test", route148);
}
